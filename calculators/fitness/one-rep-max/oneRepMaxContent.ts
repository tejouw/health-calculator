...
export const oneRepMaxContent: CalculatorContent = {
  en: {
    ...
    categories: [
      {
        range: '< 0.5× bodyweight',
        label: 'Beginner',
        description:
          'Building foundational strength. Focus on proper form, movement quality, and progressive overload rather than weight.',
        color: '#F59E0B',
      },
      {
        range: '0.5–1.0× bodyweight',
        label: 'Intermediate',
        description:
          'Solid strength base developing. Consistent training history showing meaningful progress in the main lifts.',
        color: '#3B82F6',
      },
      {
        range: '1.0–1.5× bodyweight',
        label: 'Advanced',
        description:
          'Strong lifter with significant training experience. Demonstrates excellent relative strength for most exercises.',
        color: '#10B981',
      },
      {
        range: '> 1.5× bodyweight',
        label: 'Elite',
        description:
          'Exceptional strength levels typically seen in competitive powerlifters or highly experienced athletes.',
        color: '#EF4444',
      },
    ],
  ...
  tr: {
    ...
    categories: [
      {
        range: '< 0.5× vücut ağırlığı',
        label: 'Yeni Başlayan',
        description:
          'Temel kuvvet oluşturulur. Ağırlıktan önce doğru form, hareket kalitesi ve aşamalı aşırı yüklemelere odaklanın.',
        color: '#F59E0B',
      },
      {
        range: '0.5–1.0× vücut ağırlığı',
        label: 'Orta Seviye',
        description:
          'Sağlam bir kuvvet temeli gelişiyor. Ana kaldırmalarda anlamlı ilerleme gösteren tutarlı antrenman geçmişi.',
        color: '#3B82F6',
      },
      {
        range: '1.0–1.5× vücut ağırlığı',
        label: 'İleri Seviye',
        description:
          'Önemli antrenman deneyimine sahip güçlü bir kaldırıcı. Çoğu egzersiz için mükemmel göreli kuvvet sergilemektedir.',
        color: '#10B981',
      },
      {
        range: '> 1.5× vücut ağırlığı',
        label: 'Elit',
        description:
          'Rekabetçi güç kaldırıcılarda veya çok deneyimli sporcularda tipik olarak görülen olağanüstü kuvvet seviyesi.',
        color: '#EF4444',
      },
    ],
